...
> ⚠️ **[방향 전환 공지 — 회의록 09~11 반영 대기]** 이 문서 본문은 **D+10 통합
...
> **주의:** 저장소 코드는 아직 D+10 통합 상태다 — 5차 결의 반영분(D+15 게이트
> 제출본)과 PvE 전환 코드는 이 저장소 브랜치에 미반영. 본문 §4 규약 중
> "우클릭 홀드 조준"·"Shift 상승/Ctrl 하강"은 5차 결의로 **개편 예정** 상태로
> 읽을 것. 문서 본문·DECISIONS·NEXT_SPRINT의 전면 갱신은 PvE 트랙 착수 시
> 수행한다.
...
[🔵 지금] D+10 기본 전투 프로토타입 통합 완료 → dev PR 대기
