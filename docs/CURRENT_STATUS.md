...
- **마지막 업데이트:** 스프린트 B **선행개발** (B1 적대·중립 동시 배치 / B2 식별 / B3 세력별 보상 / B4 neutralShipHit·스폰 위치 / B6 호위 계약. **B5 차단 — 구축함 AI 구현 부재**. B 공식 미발효)
